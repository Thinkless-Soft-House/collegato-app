...
import { TextInput, Button, Avatar, List, Checkbox, Text, Title } from 'react-native-paper';
...
import { removerPontuacaoDocumento, validarCNPJ, validarCPF, validarData } from '../../../helpers/formHelpers';
            ...
            <ScrollView style={[styles.mtContent]}>
                ...
                <View style={styles.condicaoUsoContainer}>
                    <TouchableOpacity style={styles.checkboxContainer} onPress={() => setChecked(!checked)}>
                        <Text style={styles.checkboxLabel}>Aceito as condições gerais
                            de uso</Text>
                        <Checkbox.Android
